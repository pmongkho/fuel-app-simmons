...
export const routes: Routes = [
  ...
  { path: 'reports/mine/:reportId', component: AdminReportDetailComponent, canActivate: [authGuard, roleGuard(['Employee', 'Admin'])] },
  ...
  { path: 'admin/dashboard', component: AdminDashboardComponent, canActivate: [authGuard, roleGuard(['Supervisor', 'Admin'])] },
  { path: 'admin/users', component: AdminUsersComponent, canActivate: [authGuard, roleGuard(['Admin'])] },
  { path: 'admin/reports/:reportId', component: AdminReportDetailComponent, canActivate: [authGuard, roleGuard(['Supervisor', 'Admin'])] },
